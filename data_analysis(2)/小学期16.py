...
# Visualization
# 1. Distribution of features in training data
plt.figure(figsize=(14, 8))
plt.subplot(2, 3, 1)
sns.histplot(Train_data['useDate'], kde=True)
plt.title('useDate Distribution')

plt.subplot(2, 3, 2)
sns.histplot(Train_data['brand'], kde=True)
plt.title('brand Distribution')

plt.subplot(2, 3, 3)
sns.histplot(Train_data['kilometer'], kde=True)
plt.title('kilometer Distribution')

plt.subplot(2, 3, 4)
sns.histplot(Train_data['bodyType'], kde=True)
plt.title('bodyType Distribution')

plt.subplot(2, 3, 5)
sns.histplot(Train_data['fuelType'], kde=True)
plt.title('fuelType Distribution')

plt.subplot(2, 3, 6)
sns.histplot(Train_data['gearbox'], kde=True)
plt.title('gearbox Distribution')

plt.tight_layout()
plt.show()

# 2. Confusion matrix of validation results
